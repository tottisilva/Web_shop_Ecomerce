...
const stripePromisse = loadStripe(process.env.REACT_APP_STRIPE_PUBLIC_KEY);
...
const PaymentForm = ({ checkoutToken, backStep, shippingData, onCaptureCheckout, nextStep }) => {
    ...
    const handleSubmit = async (event, elements, stripe) => {
        ...
        if(error){
            ...
            const orderData = {
                line_items: checkoutToken.live.subtotal.line_items,
                customer: {
                ...
                fullfilment: {shippingMethod: shippingData.shippingOption},
                payment: {
                    gateway: 'stripe',
                    stripe: {
